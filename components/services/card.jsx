...
export default function card({icon, title, desc,}) {
  return (
    <Link href="/layanan" className={"shadow-sm rounded-md p-4 flex-center flex-col text-center bg-light cursor-pointer border-2 md:hover:border-2 md:border-black  hover:shadow-xl md:hover:mx-10 transition-all ease-in-out"}>
