...
const Information = () => {
  return (
    <div id="pusat-informasi" className="mb-6">
      <h2 className="h2 mb-6">Pusat Informasi</h2>
      ...
      <div>
        <div className="lg:float-right lg:ml-4 max-lg:my-4 max-md:w-full">
          <Image src={satpamIlustrasi} alt="profile" width={500} height={600} className="rounded-lg shadow-lg max-md:w-full"/>
        </div>
